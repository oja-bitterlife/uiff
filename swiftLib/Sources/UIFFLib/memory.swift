...
public struct WRAMAlloc16 {
    var pool: (Int32, Int32, Int32, Int32)
    public init() {
        self.pool = (0, 0, 0, 0)
    }
    public mutating func getPtr() -> UnsafePointer<Int32> {
        return withUnsafePointer(to: &self.pool.0) { ptr in
            return ptr
        }
    }
}
public struct WRAMAlloc64 {
    var pool: (WRAMAlloc16, WRAMAlloc16, WRAMAlloc16, WRAMAlloc16)
    public init() {
...
public struct WRAMAlloc256 {
    var pool: (WRAMAlloc64, WRAMAlloc64, WRAMAlloc64, WRAMAlloc64)
    public init() {
...
public struct WRAMAlloc1k {
    var pool: (WRAMAlloc256, WRAMAlloc256, WRAMAlloc256, WRAMAlloc256)
    public init() {
...
public struct WRAMAlloc4k {
    var pool: (WRAMAlloc1k, WRAMAlloc1k, WRAMAlloc1k, WRAMAlloc1k)
    public init() {
...
public struct WRAMAlloc16k {
    var pool: (WRAMAlloc4k, WRAMAlloc4k, WRAMAlloc4k, WRAMAlloc4k)
    public init() {
